...
\paragraph{p.5 2. On-board radar : As deﬁned in previous section, three}作为局部论证段落阅读，关注它如何服务主问题。 / Read as a local argument and ask how it supports the main question.
