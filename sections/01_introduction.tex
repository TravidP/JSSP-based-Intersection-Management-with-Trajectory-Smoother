...
\end{itemize}
\hl{we find that there are fewer research that incorporate both high-level scheduling and low-level trajectory smoothing in the context of autonomous intersection management. This paper aims to fill this gap by proposing a hierarchical framework that integrates JSSP-based scheduling with smooth trajectory optimization.}
